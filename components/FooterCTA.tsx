    ...
    >
      <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
        ...
        <ScrollReveal delay={0.25} className="mt-10">
          <div
            className="inline-flex items-center gap-4 px-6 py-4 border"
            style={{
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 text-xs tracking-wider text-white/50 hover:text-white transition-colors duration-300"
            >
              築時數位
